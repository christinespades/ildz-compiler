...
add more needed instructions  
simd  
multi-threading  
benchmark  
the caching, hashing, and symbol resolution system  
more benchmarks  
nativize windows, vulkan, glfw, etc.  
write more sophisticated demos  
improve the compiler logging/feedback  
